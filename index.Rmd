...
### Why Death Grips gives you adrenaline: **energy** {data-commentary-width="500"}
...
### Why Death Grips does not make you much happier: **valence**, danceability and instrumentalness {data-commentary-width="500"}
...
Let us combine the information of the previous plot and add data about valence, instrumentalness and danceability. The graph is interactive, so try it out!
...
### Death Grips’ most popular song: **chroma** {data-commentary-width="500"}
...
### Death Grips’ instrumentals: **chordogram** {data-commentary-width="500"}
...
I found out albums where MC Ride is rapping, do not work well in chordograms. Those chordograms show up almost completely dark blue. I think this is caused by the fact that songs with MC Ride are even more rapid and choatic than the instrumentals. Moreover, the instrumental songs show a clearer melody, because they do not contain vocals and lyrics that influence the chordogram.

Luckily, I've included two instrumental albums in my corpus. MC Ride may fool the chordograms, but Zach and Andy provide us more clear ones. After a long search, I finally found a song that shows a clear melody: *Runway H*. It is a song with a loud bass, slow drums and loud synths.
...
### Most experimental songs: **timbre cepstrogram** {data-commentary-width="500"}
...
### Most experimental songs: **timbre and self-similarity** {data-commentary-width="500"}
...
### Low **novelty** in **loudness** and high **tempo** {data-commentary-width="500"}
...
corpus_dist %>% 
  ...
  dendro_data() %>%
  ggdendrogram(hang = -1, cex = 0.6)
```

***

It depends on the interpretation of “experimental”, but I think it is part of being experimental if a band continuously tries to reinvent themself. If this is the case, I would expect the corpus to be harder to cluster, since the songs differ from the others.

However, I think Death Grips’ music does not have a very big range of types of music. They may be experimental and evolutionary compared to other music, but within their corpus, it is not very diverse. 

### Conclusion

***What makes Death Grips experimental?***

We've seen that **Death Grips’** music is energetic and sad, which equals aggressiveness. I am very convinced that this is part of what makes Death Grips experimental, since the valence levels were remarkably low and energy levels remarkably high. Ofcourse, a lot of music is aggressive, but Death Grips introduced a new type of aggressiveness with their progressive blend of punk rock, hip-hop and industrial music.

However, their experimentalness did not show in change (novelties) or uniqueness within the songs. We've seen that the experimental songs *Fuck Me Out* and *Hot Head* are very similar to themselves. Furthermore, *Up My Sleeves* did not contain huge novelties in loudness. I concluded that the songs are still experimental, just the same experimentalness throughout the songs. I suggest that this leaves room for Death Grips to reinvent themselves and become even more experimental, inaccesible and unlistenable (if they plan on making more music).
