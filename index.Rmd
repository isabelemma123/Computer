...
This chromagram is made from the song *Get Got*, Death Grips' most popular song. As you can see, the chromagram is just as messy as the song, which makes sense. However, it is not weird for a chromagram of a hiphop song to look like this. Hiphop is mostly defined by its rythm. // We distuinguish hiphop mostly by its rythm.
